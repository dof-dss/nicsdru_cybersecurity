(function ($, Drupal) {
  ...
  Drupal.behaviors.menu = {
    attach: function(context, settings) {
      ...
      $(".menu_main--item-text, .menu_main--item .next", context).click(function () {
      ...
      $(".menu_main--grad", context).click(function () {
      ...
      $(".burger-nav", context).on("click", function () {
      ...
      $(".menu-close", context).on("click", function () {
      ...
      $(".menu_main--sub--buttons .back", context).click(function () {
        if ($(window).width() < 765) {
          $(this).parents(".menu_main--sub").toggleClass("tw-hidden");
        }
      })
    }
  }
